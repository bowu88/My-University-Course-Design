...
public class MapFragment$$ViewInjector {
  public static void inject(Finder finder, final tk.fjnugis.danger.ui.fragment.MapFragment target, Object source) {
    View view;
  ...
  public static void reset(tk.fjnugis.danger.ui.fragment.MapFragment target) {
    target.mapView = null;
